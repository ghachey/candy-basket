...
var directives = angular.module('candybasket.directives', []);
...
// angular.module('candybasket.directives.resultsTimeline', []);
// angular.module('candybasket.directives.resultsTimeline').directive('resultsTimeline',
// 	['$sourceData',
// 	function ($sourceData) {
// 	return {
// 	    restrict: 'AE',
// 	    template: '<div id="results-timeline">Hello, World!</div>',
// 	    scope: {
// 					sourceData: '@',
// 					width: '@',
// 					height: '@'
...
// 							if (typeof($scope.timelineWidth) === 'undefined'){
// 									$scope.timelineWidth = '900';
// 							}
// 							if (typeof($scope.timelineHeight) === 'undefined'){
// 									$scope.timelineHeight = '600';
// 							}
...
// 									debug:              false,
// 									font:               "Helvetica",
// 									thumbnail_url:      'http://vila:3030/'
// 							};

// 							if (typeof $scope.timeline === 'undefined'){
// 									$scope.timeline = new VMM.Timeline('results-timeline');
// 									$scope.timeline.init(timeline_conf);
// 							}
// 							else {
// 									$scope.timeline.reload(function(){return timelineData});
// 							}
// 					}
// 			}
// 	};
