...
describe('Filter: candiesAfterDate', function () {
  ...
  var candiesAfterDate;
  beforeEach(inject(function ($filter) {
    candiesAfterDate = $filter('candiesAfterDate');
  }));

  it('should only keep candies after cutoff date', function () {
